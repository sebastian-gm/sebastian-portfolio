...
const ARCHITECTURE_STEPS = [
  ...
  },
  {
    ...
    description:
      'Azure OpenAI answers policy and workflow questions from retrieved context, while Document Intelligence extracts invoice fields for a finance automation scenario.',
    bullets: [
